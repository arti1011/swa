...
public enum ArchiveBuilder {
	...
	private void addManifestMf() {
		// Zeilen in META-INF\Manifest.mf duerfen laut Java-Spezifikation nur 69
		// Zeichen breit sein
	...
	private void addJars() {
		...
		archive.addAsLibraries(pomResolver.resolve("org.richfaces:richfaces").withTransitivity().asFile());
	}
