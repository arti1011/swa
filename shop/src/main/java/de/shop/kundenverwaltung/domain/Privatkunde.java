...
@NamedQueries({@NamedQuery(name = Privatkunde.FIND_BY_GESCHLECHT, query = "SELECT  k" + " FROM Privatkunde k"
...
public class Privatkunde extends AbstractKunde {
	...
	public String toString() {
		return "Privatkunde [" + super.toString() + ", familienstand=" + familienstand + ", geschlecht=" + geschlecht
				+ ", hobbies=" + hobbies + "]";
	}
