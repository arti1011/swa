...
public class AuthService implements Serializable {
	...
	/*
	 * siehe http://community.jboss.org/thread/169263 siehe https://docs.jboss.org/author/display/AS7/Management+Clients
	 * siehe
	 * https://github.com/jbossas/jboss-as/blob/master/controller-client/src/main/java/org/jboss/as/controller/client
	 * /ModelControllerClient.java siehe http://community.jboss.org/wiki/FormatOfADetypedOperationRequest siehe
	 * http://community.jboss.org/wiki/DetypedDescriptionOfTheAS7ManagementModel
	 * 
	 * Gleicher Ablauf mit CLI (= command line interface): cd %JBOSS_HOME%\bin jboss-cli.bat -c
	 * --command=/subsystem=security/security-domain=shop:flush-cache(principal=myUserName)
	 */
	...
	public List<String> findUsernameListByUsernamePrefix(String usernamePrefix) {
		return em.createNamedQuery(FIND_USERNAME_BY_USERNAME_PREFIX, String.class)
				.setParameter(PARAM_USERNAME_PREFIX, usernamePrefix + '%').getResultList();
	}
