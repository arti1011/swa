...
@NamedQueries({
		@NamedQuery(name = Bestellung.FIND_BESTELLUNGEN_BY_KUNDEID, query = "SELECT b" + " FROM   Bestellung b"
				+ " WHERE  b.kunde.id = :" + Bestellung.PARAM_KUNDEID),
		@NamedQuery(name = Bestellung.FIND_KUNDE_BY_ID, query = "SELECT DISTINCT b.kunde" + " FROM   Bestellung b"
				+ " WHERE  b.id = :" + Bestellung.PARAM_ID),
		@NamedQuery(name = Bestellung.FIND_ANZ_BESTELLUNGEN_BY_PLZ_V1, query = "SELECT COUNT(b)"
				+ " FROM   Bestellung b" + " WHERE  b.kunde.adresse.plz BETWEEN :" + Bestellung.PARAM_PLZ_MIN
				+ " AND :" + Bestellung.PARAM_PLZ_MAX),
		@NamedQuery(name = Bestellung.FIND_ANZ_BESTELLUNGEN_BY_PLZ_V2, query = "SELECT COUNT(b)"
				+ " FROM   AbstractKunde k JOIN k.bestellungen b" + " WHERE  k.adresse.plz BETWEEN :"
				+ Bestellung.PARAM_PLZ_MIN + " AND :" + Bestellung.PARAM_PLZ_MAX) })
@Cacheable
@XmlRootElement
public class Bestellung implements Serializable {
	...
	public String toString() {
		return "Bestellung [id=" + id + ", version=" + version + ", kundeUri=" + kundeUri + ", erzeugt=" + erzeugt
